export default {
  route: {
    ...
    tempRoleCreation: 'Temp Role Creation',
    tempRoleEdit: 'Temp Role Edit',
  ...
  login: {
    title: 'Login Form',
    logIn: 'Log in',
    username: 'Mobile/Email/LoginName',
    password: 'Password',
    any: 'any',
  ...
  guide: {
    description: 'The guide page is useful for you to understand the basic features of this system',
    button: 'Show Guide'
  },
  components: {
    documentation: 'Documentation',
