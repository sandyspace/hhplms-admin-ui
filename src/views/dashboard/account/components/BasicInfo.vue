      ...
      <div class="text item">
        <el-form ref="selfAccountForm" label-position="left" label-width="150px" size="mini">
          ...
          <el-form-item label="昵称">
            <span>{{ profile.basicInfo.nickName }}</span>
          </el-form-item>
        </el-form>
      </div>
    </el-card>
      ...
      <div class="text item">
        <el-form ref="selfAccountEditForm" :model="selfAccount" :rules="selfAccountEditFormRules" label-position="left" label-width="150px" size="mini">
          ...
          <el-form-item label="昵称" prop="nickName" style="width: 300px">
            <el-input v-model="selfAccount.nickName" :placeholder="'请输入昵称'" />
          </el-form-item>
          <el-form-item>
            <el-button type="primary" icon="el-icon-edit" @click="updateSelfAccount()">确认</el-button>
...
import { updateSelfInfo, changePwd } from '@/api/account'
...
export default {
  ...
  created() {
    ...
    this.selfAccount.nickName = this.profile.basicInfo.nickName
      ...
      this.$refs.selfAccountEditForm.validate((valid) => {
        if (valid) {
          updateSelfInfo({
            ...
            nickName: this.selfAccount.nickName,
